...
public class AdsActivity extends AppCompatActivity {
    ...
    public FloatingActionButton fbtn_createAds;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(com.example.loginregister.GAds.AdsActivity.this);
...
//        }
        ...
        fbtn_createAds.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(com.example.loginregister.GAds.AdsActivity.this, AddAdsDetail.class);
...
//                                    Toast.makeText(getApplicationContext(), String.valueOf(allAds.get(i)), Toast.LENGTH_SHORT).show();
                                ...
                                adsRecycleView adsRecycleView = new adsRecycleView(com.example.loginregister.GAds.AdsActivity.this,allAdsInfor);
